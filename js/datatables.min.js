 ...
 *   https://datatables.net/download/#bs5/dt-2.0.1
 *
 * Included libraries:
 *  DataTables 2.0.1
 */
...
! function(n) { "use strict"; var a; "function" == typeof define && define.amd ? define(["jquery"], function(e) { return n(e, window, document) }) : "object" == typeof exports ? (a = require("jquery"), "undefined" == typeof window ? module.exports = function(e, t) { return e = e || window, t = t || a(e), n(t, e, e.document) } : module.exports = n(a, window, window.document)) : window.DataTable = n(jQuery, window, document) }(function(B, q, _) { "use strict";
    ...
    function b(e) { var t = parseInt(e, 10); return !isNaN(t) && isFinite(e) ? t : null }
    ...
    function F(e) { for (var t = [], n = 0, a = e.length; n < a; n++) e[n] && t.push(e[n]); return t } var C, U, t, e, $ = function(e, H) { var W, X, V; return $.factory(e, H) ? $ : this instanceof $ ? B(e).DataTable(H) : (X = void 0 === (H = e), V = (W = this).length, X && (H = {}), this.api = function() { return new U(this) }, this.each(function() { var n = 1 < V ? Ge({}, H, !0) : H,
                    a = 0,
                    ...
                    null !== e && "" !== e || (e = "DataTables_Table_" + $.ext._unique++, this.id = e); var u = B.extend(!0, {}, $.models.oSettings, { sDestroyWidth: o[0].style.width, sInstance: e, sTableId: e, colgroup: B("<colgroup>").prependTo(this), fastData: function(e, t, n) { return G(u, e, t, n) } }),
                        ...
                        for (g = T.length - 1; 0 <= g; g--) { var I = void 0 !== (x = T[g]).target ? x.target : void 0 !== x.targets ? x.targets : x.aTargets; for (Array.isArray(I) || (I = [I]), v = 0, b = I.length; v < b; v++) { var A = I[v]; if ("number" == typeof A && 0 <= A) { for (; C.length <= A;) re(S);
                                    ...
                                    for (y = 0, D = C.length; y < D; y++) "_all" === A ? _(y, x) : -1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function(e) { e = B(e[y].cell);
                                        A.match(/^[a-z][\w-]*$/i) && (A = "." + A), e.is(A) && _(y, x) }) } }
                    if (w)
        ...
        I = function(e) { return e.replace(d, "").replace(/<script/i, "") },
    ...
    function ye(e, t) { var n, a = e.oClasses,
            r = e.aoColumns,
            o = "header" === t ? e.nTHead : e.nTFoot,
            i = "header" === t ? "sTitle" : t; if (o) { if (("header" === t || h(e.aoColumns, i).join("")) && 1 === (n = (n = B("tr", o)).length ? n : B("<tr/>").appendTo(o)).length)
                for (var l = B("td, th", n).length, s = r.length; l < s; l++) B("<th/>").html(r[l][i] || "").appendTo(n); var u = Ce(e, o, !0); "header" === t ? e.aoHeader = u : e.aoFooter = u, B(o).children("tr").attr("role", "row"), B(o).children("tr").children("th, td").each(function() { Qe(e, t)(e, B(this), a) }) } }
    ...
    function g(e, t, n) { var a = e.oFeatures,
            r = a.bSort,
            a = a.bFilter;
    ...
    function Se(e) { var t = e.oLanguage,
            n = t.sZeroRecords,
            a = te(e); return e.iDraw < 1 && "ssp" === a || e.iDraw <= 1 && "ajax" === a ? n = t.sLoadingRecords : t.sEmptyTable && 0 === e.fnRecordsTotal() && (n = t.sEmptyTable), B("<tr/>").append(B("<td />", { colSpan: H(e), class: e.oClasses.empty.row }).html(n))[0] }

    function Te(e, t, n) { for (var i = {}, a = (B.each(t, function(e, t) { if (null !== t) { var e = e.replace(/([A-Z])/g, " $1").split(" "),
                        n = (i[e[0]] || (i[e[0]] = {}), 1 === e.length ? "full" : e[1].toLowerCase()),
                        a = i[e[0]],
                        r = function(t, n) { B.isPlainObject(n) ? Object.keys(n).map(function(e) { t.push({ feature: e, opts: n[e] }) }) : t.push(n) }; if (a[n] && a[n].contents || (a[n] = { contents: [] }), Array.isArray(t))
                        for (var o = 0; o < t.length; o++) r(a[n].contents, t[o]);
                    else r(a[n].contents, t);
                    Array.isArray(a[n].contents) || (a[n].contents = [a[n].contents]) } }), Object.keys(i).map(function(e) { return 0 !== e.indexOf(n) ? null : { name: e, val: i[e] } }).filter(function(e) { return null !== e })), r = (a.sort(function(e, t) { e = +e.name.replace(/[^0-9]/g, ""); return +t.name.replace(/[^0-9]/g, "") - e }), "bottom" === n && a.reverse(), []), o = 0, l = a.length; o < l; o++) a[o].val.full && (r.push({ full: a[o].val.full }), we(e, r[r.length - 1]), delete a[o].val.full), Object.keys(a[o].val).length && (r.push(a[o].val), we(e, r[r.length - 1])); return r }
    ...
    function Ne(e, t, n, a, r) { if ("" !== n)
            for (var o = 0, i = "function" == typeof n ? n : null, l = n instanceof RegExp ? n : i ? null : function(e, t) { var a = [],
                        t = B.extend({}, { boundary: !1, caseInsensitive: !0, exact: !1, regex: !1, smart: !0 }, t); "string" != typeof e && (e = e.toString()); if (e = R(e), t.exact) return new RegExp("^" + je(e) + "$", t.caseInsensitive ? "i" : ""); { var n, r, o;
    ...
    function Oe(n) { var a, e, t, r, o, i, l = n.iInitDisplayStart;
        n.bInitialised ? (ye(n, "header"), ye(n, "footer"), xe(n, n.aoHeader), xe(n, n.aoFooter), _e(n), t = (e = n).nTHead, i = t.querySelectorAll("tr"), r = e.bSortCellsTop, o = ':not([data-dt-order="disable"]):not([data-dt-order="icon-only"])', !0 === r ? t = i[0] : !1 === r && (t = i[i.length - 1]), Ve(e, t, t === e.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o), Be(e, r = [], e.aaSorting), e.aaSorting = r, Xe(n), w(n, !0), ee(n, null, "preInit", [n], !0), g(n), "ssp" != (i = te(n)) && ("ajax" == i ? Ie(n, {}, function(e) { var t = Ae(n, e); for (a = 0; a < t.length; a++) Y(n, t[a]);
            n.iInitDisplayStart = l, g(n), w(n, !1), ke(n) }) : (ke(n), w(n, !1)))) : setTimeout(function() { Oe(n) }, 200) }
    ...
    function Ve(c, e, t, n, d) { Je(e, t, function(s) { var u = void 0 === n ? le(s.target) : [n];
            u.length && (w(c, !0), setTimeout(function() { for (var e = 0, t = u.length; e < t && (! function(e, t, n, a) {
                        function r(e, t) { var n = e._idx; return (n = void 0 === n ? s.indexOf(e[1]) : n) + 1 < s.length ? n + 1 : t ? null : 0 } var o, i = e.aoColumns[t],
                            l = e.aaSorting,
                            s = i.asSorting;
                        i.bSortable && ("number" == typeof l[0] && (l = e.aaSorting = [l]), (a || n) && e.oFeatures.bSortMulti ? -1 !== (i = h(l, "0").indexOf(t)) ? null === (o = null === (o = r(l[i], !0)) && 1 === l.length ? 0 : o) ? l.splice(i, 1) : (l[i][1] = s[o], l[i]._idx = o) : (a ? l.push([t, s[0], 0]) : l.push([t, l[0][1], 0]), l[l.length - 1]._idx = 0) : l.length && l[0][0] == t ? (o = r(l[0]), l.length = 1, l[0][1] = s[o], l[0]._idx = o) : (l.length = 0, l.push([t, s[0]]), l[0]._idx = 0)) }(c, u[e], e, s.shiftKey), 1 !== c.aaSorting.length || "" !== c.aaSorting[0][1]); e++);
                Ue(c); var n, a = c,
                    r = a.aiDisplay,
                    o = a.aiDisplayMaster,
                    i = {},
                    l = {}; for (n = 0; n < o.length; n++) i[o[n]] = n; for (n = 0; n < r.length; n++) l[r[n]] = i[r[n]];
                r.sort(function(e, t) { return l[e] - l[t] }), g(c, !1, !1), w(c, !1), d && d() }, 0)) }) }
    ...
    function nt(r, o, e) { var t, n;
        e && (t = new U(r)).one("draw", function() { e(t.ajax.json()) }), "ssp" == te(r) ? g(r, o) : (w(r, !0), (n = r.jqXHR) && 4 !== n.readyState && n.abort(), Ie(r, {}, function(e) { he(r); for (var t = Ae(r, e), n = 0, a = t.length; n < a; n++) Y(r, t[n]);
            g(r, o), ke(r), w(r, !1) })) }
    ...
    function ut(t, n) { return function(e) { return y(e) || "string" != typeof e || (e = e.replace(c, " "), t && (e = I(e)), n && (e = R(e, !1))), e } } var ct = function(e, t) { var n, a = [],
                r = e.aiDisplay,
                o = e.aiDisplayMaster,
                i = t.search,
                l = t.order,
        ...
        dt = (t("rows()", function(a, l) { void 0 === a ? a = "" : B.isPlainObject(a) && (l = a, a = ""), l = rt(l); var e = this.iterator("table", function(e) { return t = at("row", t = a, function(n) { var e = b(n),
        ...
        gt = (t("columns()", function(n, a) { void 0 === n ? n = "" : B.isPlainObject(n) && (a = n, n = ""), a = rt(a); var e = this.iterator("table", function(e) { return t = n, l = a, s = (i = e).aoColumns, u = h(s, "sName"), c = h(s, "sTitle"), e = $.util.get("[].[].cell")(i.aoHeader), d = x(O([], e)), at("column", t, function(n) { var a, e = b(n); if ("" === n) return f(s.length); if (null !== e) return [0 <= e ? e : s.length + e]; if ("function" == typeof n) return a = ct(i, l), s.map(function(e, t) { return n(t, st(i, t, 0, 0, a)) ? t : null }); var r = "string" == typeof n ? n.match(mt) : ""; if (r) switch (r[2]) {
                        case "visIdx":
                        case "visible":
